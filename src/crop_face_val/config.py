...
# Data thật nằm ở EventPick_v1, không phải EventPick
PROJECT_ROOT = Path(r"D:\Hoctap\CK_KHDL\EventPick_v1")

DATA_DIR = PROJECT_ROOT / "data"

# Folder input thật:
# D:\Hoctap\CK_KHDL\EventPick_v1\data\val\Event_Public
RAW_EVENTS_DIR = DATA_DIR / "val" / "Event_Public"

# Metadata cho riêng Event_Public
...
# ============================================================
# VAL PROCESSED OUTPUT
# ============================================================

VAL_PROCESSED_DIR = DATA_DIR / "val_processed" / "Event_Public"

VAL_PROCESSED_METADATA_PATH = (
    METADATA_DIR / "val_processed_faces_metadata.csv"
)

OVERWRITE_VAL_PROCESSED = True